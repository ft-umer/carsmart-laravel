...
Route::middleware('guest')->group(function () {
    ...
    Route::post('/sign-in', [\App\Http\Controllers\Auth\AuthenticatedSessionController::class, 'store'])->name('login.post');
    ...
    // Sign out
    Route::post('/sign-out', [\App\Http\Controllers\Auth\AuthenticatedSessionController::class, 'destroy'])->name('logout');
