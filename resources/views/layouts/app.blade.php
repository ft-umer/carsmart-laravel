...
<body class="antialiased flex h-full text-base text-foreground bg-background demo1 kt-sidebar-fixed kt-header-fixed">
    ...
    <div class="flex grow">
        ...
        <div class="kt-wrapper flex grow flex-col">
                ...
                <div class="kt-container-fixed flex justify-between items-stretch lg:gap-4" id="headerContainer">
                    ...
                    <div class="hidden lg:flex items-center gap-2 me-auto ms-4">
                        ...
                        <div class="kt-menu" data-kt-menu="true">
                            <div class="kt-menu-item" data-kt-menu-item-offset="0,10px"
                                ...
                                <button
                                    class="kt-menu-toggle kt-btn kt-btn-ghost flex items-center gap-2 text-sm font-medium px-3 py-2 rounded-lg">
                    ...
                    <div class="flex items-center gap-2.5">
                        ...
                        <button
                            ...
                            data-kt-modal-toggle="#search_modal" title="Search (f)" aria-label="Global search">
                            <i class="ki-filled ki-magnifier text-lg group-hover:text-primary"></i>
                        </button>

                        {{-- Notifications (B1) --}}
                        <button
                            class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:bg-primary/10 hover:[&_i]:text-primary relative"
                            data-kt-drawer-toggle="#notifications_drawer" title="Notifications"
                        ...
                        <button
                            ...
                            data-kt-drawer-toggle="#tasks_drawer" title="My tasks" aria-label="Open task inbox">
                        ...
                        <button
                            class="kt-btn kt-btn-ghost kt-btn-icon size-9 rounded-full hover:bg-primary/10 hover:[&_i]:text-primary"
                            data-kt-modal-toggle="#help_modal" title="Help (?)" aria-label="Open help centre">
                        ...
                        <div class="shrink-0" data-kt-dropdown="true" data-kt-dropdown-offset="10px, 10px"
                            ...
                            <div class="cursor-pointer shrink-0" data-kt-dropdown-toggle="true">
                                ...
                                <img alt="{{ $user?->name }}"
                                    class="size-9 rounded-full border-2 border-green-500 shrink-0 object-cover"
                                    src="{{ $avatar }}" />
                            </div>
                                            ...
                                            <ul class="kt-dropdown-menu-sub">
                                                ...
                                                <li>
                                                    <a class="kt-dropdown-menu-link" href="#">
                                                        ...
                                                        <span class="ms-auto inline-flex items-center"
                                                            ...
                                                            <i
                                                                class="ki-filled ki-information-2 text-base text-muted-foreground"></i>
                                                ...
                                                <li>
                                                    <a class="kt-dropdown-menu-link" href="#">
                                                        ...
                                                        <input checked class="ms-auto kt-switch" type="checkbox"
                                                            value="1" />
                                                    </a>
                                                </li>
                                            ...
                                            <ul class="kt-dropdown-menu-sub">
                                                ...
                                                <li class="active">
                                                    <a class="kt-dropdown-menu-link" href="?dir=ltr">
                                                        ...
                                                        <i
                                                            class="ki-solid ki-check-circle ms-auto text-green-500 text-base"></i>
                                                    </a>
                                                </li>
            ...
            @hasSection('page_actions')
                <div
                    class="sticky bottom-0 z-10 bg-background border-t border-border px-6 py-3 flex items-center justify-end gap-3">
                    @yield('page_actions')
                </div>
            @endif
    ...
    <div class="hidden kt-drawer kt-drawer-end flex-col max-w-[90%] w-[520px] top-0 bottom-0 end-0 bg-background border-s border-border"
        data-kt-drawer="true" data-kt-drawer-container="body" id="context_panel">
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-border shrink-0">
            ...
            <button class="kt-btn kt-btn-sm kt-btn-icon kt-btn-ghost" data-kt-drawer-dismiss="true"
        ...
        <div class="kt-tabs kt-tabs-line px-5" data-kt-tabs="true">
            <div class="flex items-center gap-5">
                <button class="kt-tab-toggle py-3 text-sm active"
                    data-kt-tab-toggle="#ctx_tab_summary">Summary</button>
        ...
        <div class="kt-tabs kt-tabs-line justify-between px-5 mb-2" data-kt-tabs="true">
            <div class="flex items-center gap-5">
                ...
                <button class="kt-tab-toggle py-3 relative" data-kt-tab-toggle="#notif_inbox">
                    Inbox
                    <span
                        class="rounded-full bg-green-500 size-[5px] absolute top-2 end-0 transform translate-y-1/2 translate-x-full"></span>
                </button>
            </div>
        </div>
    ...
    <div class="hidden kt-drawer kt-drawer-end flex-col max-w-[90%] w-[420px] top-0 bottom-0 end-0 bg-background border-s border-border"
        data-kt-drawer="true" data-kt-drawer-container="body" id="tasks_drawer">
        <div class="flex items-center justify-between px-5 py-3.5 border-b border-border shrink-0">
            ...
            <div class="kt-card">
                <div class="kt-card-content p-4">
                    <div class="kt-input flex items-center gap-2">
                        ...
                        <input type="search" class="grow bg-transparent outline-none text-sm"
                            placeholder="Search lot number, listing, auction, registration, person, company, email, phone…"
                            id="global_search_input" autofocus autocomplete="off" />
                        <kbd
                            class="text-xs text-muted-foreground border border-border rounded px-1.5 py-0.5 hidden lg:block">Esc</kbd>
                    </div>
