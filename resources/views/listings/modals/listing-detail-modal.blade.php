...
--}}
<div id="listing-detail-modal" class="fixed inset-0 z-50 hidden items-center justify-center p-3 sm:p-4" role="dialog"
    aria-modal="true" aria-labelledby="detail-modal-title">
    ...
    {{-- Panel --}}
    <div
        class="relative w-full max-w-[1100px] max-h-[92vh] bg-background border border-border rounded-2xl shadow-2xl flex flex-col overflow-hidden">
