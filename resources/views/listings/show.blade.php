...
<div class="flex flex-col xl:flex-row flex-1 overflow-hidden min-w-0">
    ...
    <div class="flex-1 min-w-0 overflow-y-auto">
        ...
        <div class="kt-scrollable-x flex gap-0.5 px-4 pt-3 border-b border-border whitespace-nowrap shrink-0">
            @foreach (['Status', 'About You', 'Specifications', 'Documents', 'Interior', 'Exterior', 'Damage & Wear', 'Technical Health', 'Valuations', 'Media', 'Pricing', 'QA', 'Auction', 'Notes', 'Activity', 'History'] as $tab)
                @php
        ...
        <div class="p-4 space-y-4">
            ...
            <div data-tab-pane="status">
                ...
                <div class="mt-4 p-4 border border-border rounded-xl bg-muted/5">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <button class="kt-btn kt-btn-xs kt-btn-outline" id="get-valuation-btn">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input class="kt-input w-full text-sm font-semibold" type="number" placeholder="e.g., 14200" value="{{ $listing['valuation'] ?? '' }}">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border border-border p-4 rounded-xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="border-2 border-dashed border-border rounded-lg p-6 text-center cursor-pointer hover:bg-muted/5 transition">
                                    <i class="ki-filled ki-add-image text-2xl text-muted-foreground mb-2 block"></i>
            ...
            <div data-tab-pane="exterior" class="hidden space-y-4">
                ...
                @foreach ([
                    ['Front Drivers Wheel', 'Wheel'],
                    ['Front Passengers Wheel', 'Wheel'],
                    ['Rear Drivers Wheel', 'Wheel'],
                    ['Rear Passengers Wheel', 'Wheel'],
                    ['Front Drivers Tyre', 'Tyre'],
                    ['Front Passengers Tyre', 'Tyre'],
                    ['Rear Drivers Tyre', 'Tyre'],
                    ['Rear Passengers Tyre', 'Tyre']
                ] as [$area, $type])
                    <div class="card border border-border p-4 rounded-xl">
                        <div class="font-semibold text-sm mb-3">{{ $area }} ({{ $type }})</div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="text-xs text-muted-foreground block mb-2">Image</label>
                                <div class="border-2 border-dashed border-border rounded-lg p-6 text-center cursor-pointer hover:bg-muted/5 transition">
            ...
            <div data-tab-pane="technical-health" class="hidden space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label class="text-xs text-muted-foreground block mb-2">Upload Service Records (Photos)</label>
                        <div class="border-2 border-dashed border-border rounded-lg p-3 text-center cursor-pointer hover:bg-muted/5">
            ...
            <div data-tab-pane="valuations" class="hidden space-y-4">
                ...
                <div class="flex justify-between items-center mb-4">
                    ...
                    <button class="kt-btn kt-btn-xs kt-btn-outline" id="refresh-all-vals">
    ...
    <div id="summary-sidebar"
        ...
        <div>
            ...
            <div class="space-y-1.5 text-xs mb-3">
                ...
                @endforeach
                <button class="kt-btn kt-btn-xs kt-btn-outline w-full mt-1" data-listing-action="view-valuation-history">
                    View All Valuations
                </button>
            </div>
...
<div id="add-valuation-modal" class="hidden fixed inset-0 z-50 items-center justify-center bg-black/50 p-4">
    <div class="bg-background border border-border rounded-xl w-full max-w-3xl max-h-[85vh] overflow-y-auto">
        ...
        <div class="flex items-center justify-between p-4 border-b border-border sticky top-0 bg-background">
            <h3 class="font-semibold text-base">Add Valuation</h3>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <input class="kt-input w-full text-sm" type="number" name="hpi_average_valuation" placeholder="17475">
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <input class="kt-input w-full text-sm" type="number" name="autotrader_sell_to_dealer_low" placeholder="e.g., 14000">
                    </div>
                    <div>
                        <label class="text-xs text-muted-foreground mb-1 block">Sell to Dealer HIGH £</label>
                        <input class="kt-input w-full text-sm" type="number" name="autotrader_sell_to_dealer_high" placeholder="e.g., 15500">
                    </div>
                </div>
            </div>
...
(function () {
    ...
    const container = document.currentScript.closest('.kt-container-fixed')
        || document;
    ...
    function activateTab(target) {
        ...
        // Sidebar visibility is handled by responsive CSS classes (hidden xl:flex)
    }
    ...
    document
        .getElementById('add-valuation-modal')
        ?.addEventListener('click', (e) => {
            if (e.target.id === 'add-valuation-modal') {
    ...
    container
        .querySelector('#save-add-valuation-btn')
        ?.addEventListener('click', () => {
            ...
            /*
            Replace with real API call to persist valuations
